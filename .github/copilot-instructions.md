...
- [lumanitech-erp-api-procurement](https://github.com/MathieuBengle/lumanitech-erp-api-procurement)
...
OWNING API:
lumanitech-erp-api-procurement

API REPOSITORY PATH:
https://github.com/MathieuBengle/lumanitech-erp-api-procurement

DOMAIN RESPONSIBILITY:
Suppliers, purchase orders, goods receipts, and vendor invoices.
...
- purchase_orders.order_number is unique
- vendor_invoices.invoice_number is unique
- order_items.quantity > 0 and total_price = quantity * unit_price
- invoice_items.quantity > 0 and total_price = quantity * unit_price
- status enums enforced per table definitions
...
NOT RESPONSIBLE FOR:
- Finance ledger and journal posting
- Client master data
- Projects and tasks
